...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('plan', sa.Enum('FREE', 'PREMIUM', 'PRO', name='plantype'), nullable=False))
    op.add_column('users', sa.Column('user_type', sa.Enum('ADMIN', 'MEMBER', name='usertype'), nullable=False))
    op.add_column('users', sa.Column('is_email_verified', sa.Boolean(), nullable=False))
    op.add_column('users', sa.Column('status', sa.Enum('ACTIVE', 'INACTIVE', name='userstatus'), nullable=False))
